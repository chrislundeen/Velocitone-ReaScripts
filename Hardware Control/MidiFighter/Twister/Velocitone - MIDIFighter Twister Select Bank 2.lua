-- @description Velocitone: Hardware: MIDIFighter Twister: (Select Bank 2)
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Switches MIDIFighter Twister to bank 2.

--[[
  Selects Bank 2 for DJ TechTools MidiFighter Twister
]]
...
InitMidiFighterTwisterSelectBank(2)
