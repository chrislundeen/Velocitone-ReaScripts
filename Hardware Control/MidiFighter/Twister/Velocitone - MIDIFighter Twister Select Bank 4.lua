-- @description Velocitone: Hardware: MIDIFighter Twister: (Select Bank 4)
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Switches MIDIFighter Twister to bank 4.

--[[
  Selects Bank 4 for DJ TechTools MidiFighter Twister
]]
...
InitMidiFighterTwisterSelectBank(4)
