-- @description Velocitone: Tag Filter: [vsti]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [vsti] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[vsti]', false))
