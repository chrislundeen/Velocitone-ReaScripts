-- @description Velocitone: Tag Filter: {user_defined_custom_tag}
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for custom tagged tracks.
...
local retval_inputs, retvals_csv = reaper.GetUserInputs("Filter Custom Track Tag", 1, "Tag", 'custom')
