-- @description Velocitone: Tag Filter: [section]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [section] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[section]', false))
