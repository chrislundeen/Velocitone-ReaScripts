-- @description Velocitone: Tag Filter: [folder]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [folder] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[folder]', false))
