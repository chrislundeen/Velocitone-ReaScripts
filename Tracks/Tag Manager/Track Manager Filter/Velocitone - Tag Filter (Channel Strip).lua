-- @description Velocitone: Tag Filter: [channelstrip]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [channelstrip] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[channelstrip]', false))
