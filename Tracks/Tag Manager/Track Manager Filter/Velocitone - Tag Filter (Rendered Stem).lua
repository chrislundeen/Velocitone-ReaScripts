-- @description Velocitone: Tag Filter: [stem]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [stem] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[stem]', false))
