-- @description Velocitone: Tag Filter: [buss]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [buss] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[buss]', false))
