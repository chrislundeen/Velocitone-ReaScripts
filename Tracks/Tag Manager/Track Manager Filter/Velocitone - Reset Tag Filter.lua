-- @description Velocitone: Reset Tag Filter
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Clears all tag filters and restores full track visibility.
...
-- Init Velocitone --------------------------------------------
local library_files = {
  'Tracks/Tag Manager/Tag Filter Reset.lua'
}
