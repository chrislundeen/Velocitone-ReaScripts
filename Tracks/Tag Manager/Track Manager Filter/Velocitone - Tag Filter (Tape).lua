-- @description Velocitone: Tag Filter: [tape]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [tape] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[tape]', false))
