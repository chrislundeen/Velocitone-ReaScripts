-- @description Velocitone: Tag Filter: [audio]
-- @author chrislundeen
-- @website https://github.com/chrislundeen/
-- @version 1.0.0
-- @changelog
--   Initial Velocitone release. Toggles track visibility filter for [audio] tagged tracks.
...
reaper.SetToggleCommandState(sec, cmd, InitTagFilter('[audio]', false))
